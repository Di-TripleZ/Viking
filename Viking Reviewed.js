...
War.prototype.killThemAll = function() {
	...
	this.winner = this.vikingArmy > this.saxonArmy ? "Vikings" :"Saxons";
	this.turns = i
}

War.prototype.showWinner = function() {
	console.log ("The winner are: " + this.winner)
	console.log ("Vikings: " + this.vikingArmy.length);
	console.log ("Saxons: " + this.saxonArmy.length);
	console.log ("Turns: " + this.turns)
}

saxonWeapons = [new Weapon('Staff', 1), new Weapon('Hammer',2,1), new Weapon ('Wooden Shield',1,2)]
vikingWeapons = [new Weapon('Combat Axe',5,2) new Weapon('Mace',7,0), new Weapon('Iron Shield',2,5)]
